...
public class DLX {
	...
	public static int PC, op, a, b, c, format; 
	
	// emulated memory
	public static final int MemSize = 10000; // bytes in memory (divisible by 4)
	public static int M[] = new int [MemSize/4];
	...
	public static void load(int program[]) {
		...
		for (int j=0; j < i; j++) { 
		  ...
		  PC = j;
			disassem(M[j]);
		 // System.err.println(disassemble(M[j]));
			System.out.println(j + ": "+ mnemo[op] + " " + a + " , " + b + " , "+ c);
		}
	...
	public static final int ERR = 63; // error opcode which is insertered by loader 
	                           // after end of program code

	public static void disassem(int instructionWord) {
